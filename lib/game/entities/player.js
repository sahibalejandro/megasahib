...
.defines(function (){
  ig.Timer.prototype.running  = true;
  ig.Timer.prototype._pause   = ig.Timer.prototype.pause;
  ig.Timer.prototype._unpause = ig.Timer.prototype.unpause;
  ig.Timer.prototype._set     = ig.Timer.prototype.set;
  ig.Timer.prototype._reset   = ig.Timer.prototype.reset;
  
  ig.Timer.prototype.pause = function()
  {
    this.running = false;
    this._pause();
  };

  ig.Timer.prototype.unpause = function ()
  {
    this.running = true;
    this._unpause();
  };

  ig.Timer.prototype.set = function (s)
  {
    this.running = true;
    this._set(s);
  };

  ig.Timer.prototype.reset = function ()
  {
    this.running = true;
    this._reset();
  };
  ...
  EntityPlayer = ig.Entity.extend({
    ...
    update: function ()
    {
      ...
      if (this.standing && (ig.input.pressed('left') || ig.input.pressed('right'))) {
        ...
        if (this.TimerDashKeyCombo.tick() < 0.2) {
